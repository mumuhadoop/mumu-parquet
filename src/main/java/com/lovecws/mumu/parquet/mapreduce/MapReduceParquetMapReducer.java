 ...
 * @Description: mapreduce运行程序
 * @date 2017-10-18 11:02
 */
public class MapReduceParquetMapReducer extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new MapReduceParquetMapReducer(),args);
    }
}
